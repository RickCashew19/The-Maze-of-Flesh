...
//			attackCanceled = false;
	...
	public void monitorShards() {
	    ...
	    if (shardIndex != 999 && inventory.get(shardIndex).amount >= 5) {
	        // Remove 5 shards
	        inventory.get(shardIndex).amount -= 5;
	        ...
	        // Trigger effects
	        gp.playSE(15);
	        // Start dialogue or other effects
	        removeAllFleshWalls();
	    }
	}
	
    private void removeAllFleshWalls() {
        // Remove all flesh wall objects from the map
	...
	// Call this after every inventory change involving shards
