...
public class MON_MACHROMMAN extends Entity {
	...
	public static final String monName = "man Monster";

	public MON_MACHROMMAN(GamePanel gp) {
		super(gp);
		this.gp = gp;
	...
	private void getImage() {
		up1 = setup("/monster/mansho02", gp.tileSize, gp.tileSize);
		up2 = setup("/monster/mansho3", gp.tileSize, gp.tileSize);
		down1 = setup("/monster/mansho02", gp.tileSize, gp.tileSize);
		down2 = setup("/monster/mansho3", gp.tileSize, gp.tileSize);
		left1 = setup("/monster/mansho01", gp.tileSize, gp.tileSize);
		left2 = setup("/monster/mansho02", gp.tileSize, gp.tileSize);
		right1 = setup("/monster/mansho01", gp.tileSize, gp.tileSize);
		right2 = setup("/monster/mansho02", gp.tileSize, gp.tileSize);
	}
