...
public class MON_Mossrock extends Entity {
	...
	public MON_Mossrock(GamePanel gp) {
		super(gp);
		this.gp = gp;
	...
	private void getImage() {
		up1 = setup("/monster/mossyrock_down1", gp.tileSize*2, gp.tileSize*2);
		up2 = setup("/monster/mossrock_side01", gp.tileSize*2, gp.tileSize*2);
		down1 = setup("/monster/mossyrock_down1", gp.tileSize*2, gp.tileSize*2);
		down2 = setup("/monster/mossrock_side01", gp.tileSize*2, gp.tileSize*2);
		left1 = setup("/monster/mossrock_side01", gp.tileSize*2, gp.tileSize*2);
		left2 = setup("/monster/mossrock_side02", gp.tileSize*2, gp.tileSize*2);
		right1 = setup("/monster/mossrock_side01", gp.tileSize*2, gp.tileSize*2);
		right2 = setup("/monster/mossrock_side02", gp.tileSize*2, gp.tileSize*2);
	}

	private void getAttackImage() {
		attackUp1 = setup("/monster/mini03", gp.tileSize, gp.tileSize*2);
		attackUp2 = setup("/monster/mini02", gp.tileSize, gp.tileSize*2);
		attackDown1 = setup("/monster/mini03", gp.tileSize, gp.tileSize*2);
		attackDown2 = setup("/monster/mini02", gp.tileSize, gp.tileSize*2);
		attackLeft1 = setup("/monster/mini03", gp.tileSize*2, gp.tileSize);
		attackLeft2 = setup("/monster/mini02", gp.tileSize*2, gp.tileSize);
		attackRight1 = setup("/monster/mini03", gp.tileSize*2, gp.tileSize);
		attackRight2 = setup("/monster/mini02", gp.tileSize*2, gp.tileSize);
	}
