...
public class MON_Minicutie extends Entity {
	...
	public static final String monName = "Minicutie Monster";

	public MON_Minicutie(GamePanel gp) {
		super(gp);
		this.gp = gp;
	...
	private void getImage() {
		up1 = setup("/monster/mini03", gp.tileSize, gp.tileSize);
		up2 = setup("/monster/mini02", gp.tileSize, gp.tileSize);
		down1 = setup("/monster/mini03", gp.tileSize, gp.tileSize);
		down2 = setup("/monster/mini02", gp.tileSize, gp.tileSize);
		left1 = setup("/monster/mini01", gp.tileSize, gp.tileSize);
		left2 = setup("/monster/mini02", gp.tileSize, gp.tileSize);
		right1 = setup("/monster/mini01", gp.tileSize, gp.tileSize);
		right2 = setup("/monster/mini02", gp.tileSize, gp.tileSize);
	}
