...
public class OBJ_FLESH_WALL extends Entity {

	GamePanel gp;
	public static final String objName = "Flesh Wall";
	 public String wallDirection;

	public OBJ_FLESH_WALL(GamePanel gp, String direction) {
		super(gp);
		this.gp = gp;
    ...
    private void getImage(String direction) {
        if (direction.equals("vertical01")) {
            down1 = setup("/tiles/tile_051", gp.tileSize, gp.tileSize);
            
        } else if (direction.equals("vertical02")) {
            down1 = setup("/tiles/tile_052", gp.tileSize, gp.tileSize);
            
        } else if (direction.equals("vertical03")) {
            down1 = setup("/tiles/tile_053", gp.tileSize, gp.tileSize);
            
        } 
        
        else if (direction.equals("horizontal01")) {
            down1 = setup("/tiles/tile_024", gp.tileSize, gp.tileSize);
            
        } else if (direction.equals("horizontal02")) {
            down1 = setup("/tiles/tile_025", gp.tileSize, gp.tileSize);
            
        } else if (direction.equals("horizontal03")) {
            down1 = setup("/tiles/tile_026", gp.tileSize, gp.tileSize);
            
        } else if (direction.equals("horizontal04")) {
            down1 = setup("/tiles/tile_027", gp.tileSize, gp.tileSize);
            
        } else if (direction.equals("horizontal05")) {
            down1 = setup("/tiles/tile_028", gp.tileSize, gp.tileSize);
            
        } else if (direction.equals("horizontal06")) {
            down1 = setup("/tiles/tile_029", gp.tileSize, gp.tileSize);
        }
